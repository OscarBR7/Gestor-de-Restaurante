...
#Etiqueta titulo        Se indica primero en que elemento va
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturación', fg='azure4',
                        font=('Dosis', 32), bg='burlywood', width=27)
etiqueta_titulo.grid(row=0, column=0)

#Panel izquierdo Se crean los paneles, luego se deben de meter cosas dentro de estos
...
#Lista de productos
lista_comidas = ['Pollo', 'Salmon', 'Enchiladas', 'Mole', 'Pozole', 'Pizza', 'Sopes','Carne']
lista_bebidas = ['Agua', 'Refresco', 'Jugo', 'Vino', 'ChampuLadyGaGa','Moet','Cerveza','Tequila']
lista_postres = ['Helado', 'Pastel','Pay','Brownies','Flan','Panque','Ensalada de Manzana', 'Gelatina']
